...
public class DbExportTest_Firebird {
	...
	public static void setupTestClass() throws Exception {
		...
		DATA_VALUES =
				new Object[][]{
			new Object[]{ 1, 1.123, TextUtilities.GERMAN_TEST_STRING, TextUtilities.GERMAN_TEST_STRING.getBytes(StandardCharsets.UTF_8), TextUtilities.GERMAN_TEST_STRING, TEST_DATETIME},
			new Object[]{ 2, 2.123, TextUtilities.GERMAN_TEST_STRING, TextUtilities.GERMAN_TEST_STRING.getBytes(StandardCharsets.UTF_8), TextUtilities.GERMAN_TEST_STRING, TEST_DATETIME},
		...
		try (Connection connection = DbUtilities.createConnection(new DbDefinition(DbVendor.Firebird, HOSTNAME, DBNAME, USERNAME, PASSWORD.toCharArray()), false)) {
			...
			try (PreparedStatement preparedStatement = connection.prepareStatement("INSERT INTO test_tbl (id, " + dataColumnsPartForInsert + ") VALUES (COALESCE((SELECT MAX(id) + 1 FROM test_tbl), 1), " + Utilities.repeat("?", DATA_TYPES.length, ", ") + ")")) {
	...
	public void testCsvSelect() {
		try {
			DbExport._main(new String[] { "firebird", HOSTNAME, DBNAME, USERNAME, "-export", "SELECT COLUMN_VARCHAR FROM test_tbl WHERE id < 3", "-output", "~" + File.separator + "temp" + File.separator + "test_tbl.csv", PASSWORD });
	...
	public void testCsv() {
		try {
			DbExport._main(new String[] { "firebird", HOSTNAME, DBNAME, USERNAME, "-export", "test_tbl", "-output", "~" + File.separator + "temp" + File.separator + "", PASSWORD });
	...
	public void testCsvWithNullString() {
		try {
			DbExport._main(new String[] { "firebird", HOSTNAME, DBNAME, USERNAME, "-export", "test_tbl", "-output", "~" + File.separator + "temp" + File.separator + "", "-n", "NULL", PASSWORD });
	...
	public void testCsvBeautified() {
		try {
			DbExport._main(new String[] { "firebird", HOSTNAME, DBNAME, USERNAME, "-export", "test_tbl", "-output", "~" + File.separator + "temp" + File.separator + "", "-beautify", PASSWORD });
	...
	public void testCsvZipped() {
		try {
			DbExport._main(new String[] { "firebird", HOSTNAME, DBNAME, USERNAME, "-export", "test_tbl", "-output", "~" + File.separator + "temp" + File.separator + "", "-z", PASSWORD });
	...
	public void testJsonBeautified() {
		try {
			DbExport._main(new String[] { "firebird", HOSTNAME, DBNAME, USERNAME, "-export", "test_tbl", "-output", "~" + File.separator + "temp" + File.separator + "", "-x", "json", "-beautify", PASSWORD });
	...
	public void testJson() {
		try {
			DbExport._main(new String[] { "firebird", HOSTNAME, DBNAME, USERNAME, "-export", "test_tbl", "-output", "~" + File.separator + "temp" + File.separator + "", "-x", "json", PASSWORD });
			...
			Assert.assertEquals(
					"["
							...
							+ "{\"ID\":3,\"COLUMN_BLOB\":null,\"COLUMN_CLOB\":null,\"COLUMN_DOUBLE\":null,\"COLUMN_INTEGER\":null,\"COLUMN_TIMESTAMP\":null,\"COLUMN_VARCHAR\":null}"
							+ "]",
							FileUtilities.readFileToString(OUTPUTFILE_JSON, StandardCharsets.UTF_8).replace(TextUtilities.GERMAN_TEST_STRING.replace("\"", "\\\""), "<test_text>").replace(Utilities.encodeBase64(TextUtilities.GERMAN_TEST_STRING.getBytes(StandardCharsets.UTF_8)), "<test_text_base64>"));
		} catch (final Exception e) {
			Assert.fail(e.getMessage());
	...
	public void testXmlBeautified() {
		try {
			DbExport._main(new String[] { "firebird", HOSTNAME, DBNAME, USERNAME, "-export", "test_tbl", "-output", "~" + File.separator + "temp" + File.separator + "", "-x", "xml", "-beautify", PASSWORD });
	...
	public void testXmlWithNullString() {
		try {
			DbExport._main(new String[] { "firebird", HOSTNAME, DBNAME, USERNAME, "-export", "test_tbl", "-output", "~" + File.separator + "temp" + File.separator + "", "-x", "xml", "-n", "NULL", PASSWORD });
			...
			Assert.assertEquals(
					"<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
							...
							+ "<line><ID>2</ID><COLUMN_BLOB><test_text_base64></COLUMN_BLOB><COLUMN_CLOB><test_text></COLUMN_CLOB><COLUMN_DOUBLE>2,123</COLUMN_DOUBLE><COLUMN_INTEGER>2</COLUMN_INTEGER><COLUMN_TIMESTAMP>01.02.2003 04:05:06</COLUMN_TIMESTAMP><COLUMN_VARCHAR><test_text></COLUMN_VARCHAR></line>"
							+ "<line><ID>3</ID><COLUMN_BLOB>NULL</COLUMN_BLOB><COLUMN_CLOB>NULL</COLUMN_CLOB><COLUMN_DOUBLE>NULL</COLUMN_DOUBLE><COLUMN_INTEGER>NULL</COLUMN_INTEGER><COLUMN_TIMESTAMP>NULL</COLUMN_TIMESTAMP><COLUMN_VARCHAR>NULL</COLUMN_VARCHAR></line>"
							+ "</table>",
							FileUtilities.readFileToString(OUTPUTFILE_XML, StandardCharsets.UTF_8).replace(TextUtilities.GERMAN_TEST_STRING.replace("&", "&amp;").replace("<", "&lt;").replace(">", "&gt;"), "<test_text>").replace(Utilities.encodeBase64(TextUtilities.GERMAN_TEST_STRING.getBytes(StandardCharsets.UTF_8)), "<test_text_base64>"));
		} catch (final Exception e) {
			Assert.fail(e.getMessage());
	...
	public void testXml() {
		try {
			DbExport._main(new String[] { "firebird", HOSTNAME, DBNAME, USERNAME, "-export", "test_tbl", "-output", "~" + File.separator + "temp" + File.separator + "", "-x", "xml", PASSWORD });
			...
			Assert.assertEquals(
					"<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
							...
							+ "<line><ID>1</ID><COLUMN_BLOB><test_text_base64></COLUMN_BLOB><COLUMN_CLOB><test_text></COLUMN_CLOB><COLUMN_DOUBLE>1,123</COLUMN_DOUBLE><COLUMN_INTEGER>1</COLUMN_INTEGER><COLUMN_TIMESTAMP>01.02.2003 04:05:06</COLUMN_TIMESTAMP><COLUMN_VARCHAR><test_text></COLUMN_VARCHAR></line>"
							+ "<line><ID>2</ID><COLUMN_BLOB><test_text_base64></COLUMN_BLOB><COLUMN_CLOB><test_text></COLUMN_CLOB><COLUMN_DOUBLE>2,123</COLUMN_DOUBLE><COLUMN_INTEGER>2</COLUMN_INTEGER><COLUMN_TIMESTAMP>01.02.2003 04:05:06</COLUMN_TIMESTAMP><COLUMN_VARCHAR><test_text></COLUMN_VARCHAR></line>"
							+ "<line><ID>3</ID><COLUMN_BLOB></COLUMN_BLOB><COLUMN_CLOB></COLUMN_CLOB><COLUMN_DOUBLE></COLUMN_DOUBLE><COLUMN_INTEGER></COLUMN_INTEGER><COLUMN_TIMESTAMP></COLUMN_TIMESTAMP><COLUMN_VARCHAR></COLUMN_VARCHAR></line>"
							+ "</table>",
							FileUtilities.readFileToString(OUTPUTFILE_XML, StandardCharsets.UTF_8).replace(TextUtilities.GERMAN_TEST_STRING.replace("&", "&amp;").replace("<", "&lt;").replace(">", "&gt;"), "<test_text>").replace(Utilities.encodeBase64(TextUtilities.GERMAN_TEST_STRING.getBytes(StandardCharsets.UTF_8)), "<test_text_base64>"));
		} catch (final Exception e) {
			Assert.fail(e.getMessage());
	...
	public void testSql() {
		try {
			DbExport._main(new String[] { "firebird", HOSTNAME, DBNAME, USERNAME, "-export", "test_tbl", "-output", "~" + File.separator + "temp" + File.separator + "", "-x", "sql", PASSWORD });
			...
			Assert.assertEquals(
					"--SELECT ID, COLUMN_BLOB, COLUMN_CLOB, COLUMN_DOUBLE, COLUMN_INTEGER, COLUMN_TIMESTAMP, COLUMN_VARCHAR FROM TEST_TBL ORDER BY ID\n"
							...
							+ "INSERT INTO export_tbl (ID, COLUMN_BLOB, COLUMN_CLOB, COLUMN_DOUBLE, COLUMN_INTEGER, COLUMN_TIMESTAMP, COLUMN_VARCHAR) VALUES (3, NULL, NULL, NULL, NULL, NULL, NULL);\n",
	...
	public void testSqlSelect() throws Exception {
		try {
			DbExport._main(new String[] { "firebird", HOSTNAME, DBNAME, USERNAME, "-export", "SELECT column_varchar FROM test_tbl WHERE 1 = 1", "-output", "~" + File.separator + "temp" + File.separator + "test_tbl.sql", "-x", "sql", PASSWORD });
