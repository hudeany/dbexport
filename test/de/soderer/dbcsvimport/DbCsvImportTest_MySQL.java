...
public class DbCsvImportTest_MySQL {
	...
	public void testCsvImportNoMapping() {
		try {
			...
			Assert.assertEquals(0, DbCsvImport._main(new String[] { "mysql", HOSTNAME, USERNAME, DBNAME, "test_tbl", "~/temp/test_tbl.csv", PASSWORD }));
			Assert.assertEquals(
	...
	public void testCsvImport() {
		try {
			...
			Assert.assertEquals(0, DbCsvImport._main(new String[] { "mysql", HOSTNAME, USERNAME, DBNAME, "test_tbl", "~/temp/test_tbl.csv", "-m", mapping, PASSWORD }));
			Assert.assertEquals(
				"id;column_blob;column_clob;column_date;column_double;column_integer;column_timestamp;column_varchar\n"
	...
	public void testCsvImportTrimmed() {
		try {
			...
			Assert.assertEquals(0, DbCsvImport._main(new String[] { "mysql", HOSTNAME, USERNAME, DBNAME, "test_tbl", "~/temp/test_tbl.csv", "-m", mapping, "-t", PASSWORD }));
			Assert.assertEquals(
				"id;column_blob;column_clob;column_date;column_double;column_integer;column_timestamp;column_varchar\n"
				+ "1;;aBcDeF1234;2003-02-01;123.456;123;2003-02-01 11:12:13.0;aBcDeF123\n",
				exportTestTable());
	...
	public void testCsvImportErrorStructure() {
		try {
			...
			FileUtilities.write(INPUTFILE_CSV,
				...
				+ "123; 123.456; aBcDeF123; aBcDeF1234; 01.02.2003 11:12:13; 01.02.2003 21:22:23\n").getBytes("UTF-8"));
			String mapping = "column_integer='column integer'; column_double='column_double'; column_varchar='column_varchar'; column_clob='column_clob'; column_blob=; column_timestamp='column_timestamp'dd.MM.yyyy HH:mm:ss; column_date='column_date'dd.MM.yyyy HH:mm:ss";
			Assert.assertEquals(1, DbCsvImport._main(new String[] { "mysql", HOSTNAME, USERNAME, DBNAME, "test_tbl", "~/temp/test_tbl.csv", "-m", mapping, PASSWORD }));
			Assert.assertEquals(
				"id;column_blob;column_clob;column_date;column_double;column_integer;column_timestamp;column_varchar\n",
				exportTestTable());
		} catch (Exception e) {
	...
	public void testCsvImportErrorDataTypeRollback() {
		try {
			...
			FileUtilities.write(INPUTFILE_CSV,
				...
				+ "123; 123.456; aBcDeF123; aBcDeF1234; 01.02.2003 11:12:13; 01.02.2003 21:22:23\n").getBytes("UTF-8"));
			String mapping = "column_integer='column integer'; column_double='column_double'; column_varchar='column_varchar'; column_clob='column_clob'; column_blob=; column_timestamp='column_timestamp'dd.MM.yyyy HH:mm:ss; column_date='column_date'dd.MM.yyyy HH:mm:ss";
			Assert.assertEquals(1, DbCsvImport._main(new String[] { "mysql", HOSTNAME, USERNAME, DBNAME, "test_tbl", "~/temp/test_tbl.csv", "-m", mapping, "-c", PASSWORD }));
			Assert.assertEquals(
				"id;column_blob;column_clob;column_date;column_double;column_integer;column_timestamp;column_varchar\n",
				exportTestTable());
		} catch (Exception e) {
	...
	public void testCsvImportInsertWithKeycolumns() {
		try {
			...
			String mapping = "column_integer='column integer'; column_double='column_double'; column_varchar='column_varchar'; column_clob='column_clob'; column_blob=; column_timestamp='column_timestamp'dd.MM.yyyy HH:mm:ss; column_date='column_date'dd.MM.yyyy HH:mm:ss";
			Assert.assertEquals(0, DbCsvImport._main(new String[] { "mysql", HOSTNAME, USERNAME, DBNAME, "test_tbl", "~/temp/test_tbl.csv", "-m", mapping, "-i", "INSERT", "-k", "column_integer", PASSWORD }));
			Assert.assertEquals(
				"id;column_blob;column_clob;column_date;column_double;column_integer;column_timestamp;column_varchar\n"
				+ "1;;;;;1;;\"<test_text>_1\"\n"
				+ "2;;;;;3;;\"<test_text>_3\"\n"
	...
	public void testCsvImportUpdateWithNull() {
		try {
			...
			String mapping = "column_integer='column integer'; column_double='column_double'; column_varchar='column_varchar'; column_clob='column_clob'; column_blob=; column_timestamp='column_timestamp'dd.MM.yyyy HH:mm:ss; column_date='column_date'dd.MM.yyyy HH:mm:ss";
			Assert.assertEquals(0, DbCsvImport._main(new String[] { "mysql", HOSTNAME, USERNAME, DBNAME, "test_tbl", "~/temp/test_tbl.csv", "-m", mapping, "-i", "UPDATE", "-k", "column_integer", PASSWORD }));
			Assert.assertEquals(
				"id;column_blob;column_clob;column_date;column_double;column_integer;column_timestamp;column_varchar\n"
	...
	public void testCsvImportUpdateWithoutNull() {
		try {
			...
			String mapping = "column_integer='column integer'; column_double='column_double'; column_varchar='column_varchar'; column_clob='column_clob'; column_blob=; column_timestamp='column_timestamp'dd.MM.yyyy HH:mm:ss; column_date='column_date'dd.MM.yyyy HH:mm:ss";
			Assert.assertEquals(0, DbCsvImport._main(new String[] { "mysql", HOSTNAME, USERNAME, DBNAME, "test_tbl", "~/temp/test_tbl.csv", "-m", mapping, "-i", "UPDATE", "-k", "column_integer", "-u", PASSWORD }));
			Assert.assertEquals(
				"id;column_blob;column_clob;column_date;column_double;column_integer;column_timestamp;column_varchar\n"
	...
	public void testCsvImportUpsertWithNull() {
		try {
			...
			String mapping = "column_integer='column integer'; column_double='column_double'; column_varchar='column_varchar'; column_clob='column_clob'; column_blob=; column_timestamp='column_timestamp'dd.MM.yyyy HH:mm:ss; column_date='column_date'dd.MM.yyyy HH:mm:ss";
			Assert.assertEquals(0, DbCsvImport._main(new String[] { "mysql", HOSTNAME, USERNAME, DBNAME, "test_tbl", "~/temp/test_tbl.csv", "-m", mapping, "-i", "UPSERT", "-k", "column_integer", PASSWORD }));
			Assert.assertEquals(
				"id;column_blob;column_clob;column_date;column_double;column_integer;column_timestamp;column_varchar\n"
				+ "1;; aBcDeF1235_1;2003-03-01;123.456;1;2003-02-01 11:12:13.0;\n"
				+ "2;; aBcDeF1235_3;2003-03-01;123.456;3;2003-02-01 11:12:13.0;\n"
	...
	public void testCsvImportUpsertWithoutNull() {
		try {
			...
			String mapping = "column_integer='column integer'; column_double='column_double'; column_varchar='column_varchar'; column_clob='column_clob'; column_blob=; column_timestamp='column_timestamp'dd.MM.yyyy HH:mm:ss; column_date='column_date'dd.MM.yyyy HH:mm:ss";
			Assert.assertEquals(0, DbCsvImport._main(new String[] { "mysql", HOSTNAME, USERNAME, DBNAME, "test_tbl", "~/temp/test_tbl.csv", "-m", mapping, "-i", "UPSERT", "-k", "column_integer", "-u", PASSWORD }));
			Assert.assertEquals(
				"id;column_blob;column_clob;column_date;column_double;column_integer;column_timestamp;column_varchar\n"
	...
	public void testCsvImportUpsertAdditionalValues() {
		try {
			...
			Assert.assertEquals(0, DbCsvImport._main(new String[] { "mysql", HOSTNAME, USERNAME, DBNAME, "test_tbl", "~/temp/test_tbl.csv", "-m", mapping, "-i", "UPSERT", "-k", "column_integer", "-u", "-insvalues", "column_varchar='Insert'", "-updvalues", "column_varchar='Update'", PASSWORD }));
			Assert.assertEquals(
				"id;column_blob;column_clob;column_date;column_double;column_integer;column_timestamp;column_varchar\n"
	...
	public void testJsonImportUpsert() {
		...
		try {
			...
			String mapping = "column_integer='column integer'; column_double='column_double'; column_varchar='column_varchar'; column_clob='column_clob'; column_blob=; column_timestamp='column_timestamp'dd.MM.yyyy HH:mm:ss; column_date='column_date'dd.MM.yyyy HH:mm:ss";
			Assert.assertEquals(0, DbCsvImport._main(new String[] { "mysql", HOSTNAME, USERNAME, DBNAME, "test_tbl", "-x", "JSON", "~/temp/test_tbl.json", "-m", mapping, "-i", "UPSERT", "-k", "column_integer", PASSWORD }));
			Assert.assertEquals(
				"id;column_blob;column_clob;column_date;column_double;column_integer;column_timestamp;column_varchar\n"
				+ "1;; aBcDeF1235_1;2003-03-01;123.456;1;2003-02-01 11:12:13.0;\n"
				+ "2;; aBcDeF1235_3;2003-03-01;123.456;3;2003-02-01 11:12:13.0;\n"
	...
	public void testXmlImportUpsert() {
		...
		try {
			...
			Assert.assertEquals(0, DbCsvImport._main(new String[] { "mysql", HOSTNAME, USERNAME, DBNAME, "test_tbl", "-x", "XML", "~/temp/test_tbl.xml", "-m", mapping, "-i", "UPSERT", "-k", "column_integer", PASSWORD }));
			Assert.assertEquals(
				"id;column_blob;column_clob;column_date;column_double;column_integer;column_timestamp;column_varchar\n"
				+ "1;; aBcDeF1235_1;2003-03-01;123.456;1;2003-02-01 11:12:13.0;\n"
				+ "2;; aBcDeF1235_3;2003-03-01;123.456;3;2003-02-01 11:12:13.0;\n"
