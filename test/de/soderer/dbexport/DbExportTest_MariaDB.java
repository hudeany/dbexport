...
public class DbExportTest_MariaDB {
	...
	public void testCsv() {
		try {
			...
			assertLogContains(logData, "Exported data amount", "1.063 KiByte");
		} catch (final Exception e) {
			Assert.fail(e.getMessage());
		}
	}
	...
	public void testCsvWithNullString() {
		try {
			...
			assertLogContains(logData, "Lines to export", "3");
			assertLogContains(logData, "Exported lines", "3");
			assertLogContains(logData, "Exported data amount", "1.091 KiByte");
		} catch (final Exception e) {
			Assert.fail(e.getMessage());
		}
	}
	...
	public void testCsvBeautified() {
		try {
			...
			assertLogContains(logData, "Lines to export", "3");
			assertLogContains(logData, "Exported lines", "3");
			assertLogContains(logData, "Exported data amount", "1.93 KiByte");
		} catch (final Exception e) {
			Assert.fail(e.getMessage());
		}
	}
	...
	public void testCsvZipped() {
		try {
			...
			assertLogContains(logData, "Lines to export", "3");
			assertLogContains(logData, "Exported lines", "3");
			assertLogContains(logData, "Exported data amount", "565 Byte");
		} catch (final Exception e) {
			Assert.fail(e.getMessage());
		}
	}
	...
	public void testJsonBeautified() {
		try {
			...
			assertLogContains(logData, "Lines to export", "3");
			assertLogContains(logData, "Exported lines", "3");
			assertLogContains(logData, "Exported data amount", "1.47 KiByte");
		} catch (final Exception e) {
			Assert.fail(e.getMessage());
		}
	}
	...
	public void testJson() {
		try {
			...
			assertLogContains(logData, "Lines to export", "3");
			assertLogContains(logData, "Exported lines", "3");
			assertLogContains(logData, "Exported data amount", "1.363 KiByte");
		} catch (final Exception e) {
			Assert.fail(e.getMessage());
		}
	}
	...
	public void testXmlBeautified() {
		try {
			...
			assertLogContains(logData, "Lines to export", "3");
			assertLogContains(logData, "Exported lines", "3");
			assertLogContains(logData, "Exported data amount", "1.949 KiByte");
		} catch (final Exception e) {
			Assert.fail(e.getMessage());
		}
	}
	...
	public void testXmlWithNullString() {
		try {
			...
			assertLogContains(logData, "Lines to export", "3");
			assertLogContains(logData, "Exported lines", "3");
			assertLogContains(logData, "Exported data amount", "1.892 KiByte");
		} catch (final Exception e) {
			Assert.fail(e.getMessage());
		}
	}
	...
	public void testXml() {
		try {
			...
			assertLogContains(logData, "Lines to export", "3");
			assertLogContains(logData, "Exported lines", "3");
			assertLogContains(logData, "Exported data amount", "1.864 KiByte");
		} catch (final Exception e) {
			Assert.fail(e.getMessage());
		}
	}
	...
	public void testSql() {
		try {
			...
			assertLogContains(logData, "Lines to export", "3");
			assertLogContains(logData, "Exported lines", "3");
			assertLogContains(logData, "Exported data amount", "1.58 KiByte");
		} catch (final Exception e) {
			Assert.fail(e.getMessage());
		}
	}
	...
	public void testSqlSelectSimpleNumbers() throws Exception {
		...
		try {
			...
			assertLogContains(logData, "Exported data amount", "28 Byte");
		} catch (final Exception e) {
			Assert.fail(e.getMessage());
			throw e;
		}
